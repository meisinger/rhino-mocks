...
{
    /// <summary>
    /// Provides access to create proxied instances of types
    /// </summary>
    public partial class MockRepository
    {
        ...
        /// <returns></returns>
        public static object GenerateMock(Type type, params Type[] extraTypes)
        {
            return CreateMockInReplay(r => r.DynamicMultiMock(type, extraTypes, new object[0]));
        }
        ...
        /// <returns></returns>
        public static object GenerateMock(Type type, params object[] argumentsForConstructor)
        {
            return CreateMockInReplay(r => r.DynamicMultiMock(type, new Type[0], argumentsForConstructor));
        }
        ...
        public static T GenerateMultiMock<T>(params Type[] extraTypes)
            where T : class
        {
            return (T)GenerateMock(typeof(T), extraTypes, new object[0]);
        }
        ...
        public static object GenerateStrictMock(Type type)
        {
            return CreateMockInReplay(r => r.StrictMultiMock(type, new Type[0], new object[0]));
        }
        ...
        /// <param name="extraTypes"></param>
        /// <returns></returns>
        public static object GenerateStrictMock(Type type, params Type[] extraTypes)
        {
            return CreateMockInReplay(r => r.StrictMultiMock(type, extraTypes, new object[0]));
        }
        ...
        ///<returns>The strict multi-mock object</returns>
        /// <seealso cref="StrictMultiMock(System.Type,System.Type[],object[])"/>
        public static object GenerateStrictMock(Type type, params object[] argumentsForConstructor)
        {
            return CreateMockInReplay(r => r.StrictMultiMock(type, new Type[0], argumentsForConstructor));
        }
        ...
        ///<typeparam name="T"></typeparam>
        ///<returns></returns>
        public static T GenerateStrictMultiMock<T>(params Type[] extraTypes)
            where T : class
        {
            return CreateMockInReplay(r => r.StrictMultiMock<T>(extraTypes));
        }
        ...
        /// <param name="argumentsForConstructor"></param>
        /// <returns></returns>
        public static T GenerateStrictMultiMock<T>(Type[] extraTypes, params object[] argumentsForConstructor)
            where T : class
        {
            return CreateMockInReplay(r => r.StrictMultiMock<T>(extraTypes, argumentsForConstructor));
        }
        ...
        ///<param name="type"></param>
        ///<returns></returns>
        public static object GeneratePartialMock(Type type)
        {
            return CreateMockInReplay(r => r.PartialMultiMock(type, new Type[0], new object[0]));
        }
        ...
        /// <param name="extraTypes"></param>
        /// <returns></returns>
        public static object GeneratePartialMock(Type type, params Type[] extraTypes)
        {
            return CreateMockInReplay(r => r.PartialMultiMock(type, extraTypes, new object[0]));
        }
        ...
        ///<param name="argumentsForConstructor"></param>
        ///<returns></returns>
        public static object GeneratePartialMock(Type type, params object[] argumentsForConstructor)
        {
            return CreateMockInReplay(r => r.PartialMultiMock(type, new Type[0], argumentsForConstructor));
        }
        ...
        public static T GeneratePartialMultiMock<T>(params Type[] extraTypes)
            where T : class
        {
            return CreateMockInReplay(r => r.PartialMultiMock<T>(extraTypes));
        }
            ...
            where T : class
        {
            ...
            return CreateMockInReplay(r => r.PartialMultiMock<T>(extraTypes, argumentsForConstructor));
        }
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public static object GenerateDynamicMock(Type type)
        {
            return CreateMockInReplay(r => r.DynamicMock(type, new object[0]));
        }
        ...
        /// <param name="extraTypes"></param>
        /// <returns></returns>
        public static object GenerateDynamicMock(Type type, params Type[] extraTypes)
        {
            return CreateMockInReplay(r => r.DynamicMultiMock(type, extraTypes));
        }
        ...
        /// <param name="argumentsForConstructor"></param>
        /// <returns></returns>
        public static object GenerateDynamicMock(Type type, params object[] argumentsForConstructor)
        {
            return CreateMockInReplay(r => r.DynamicMultiMock(type, new Type[0], argumentsForConstructor));
        }
        ...
        /// <param name="argumentsForConstructor"></param>
        /// <returns></returns>
        public static object GenerateDynamicMock(Type type, Type[] extraTypes, params object[] argumentsForConstructor)
        {
            return CreateMockInReplay(r => r.DynamicMultiMock(type, extraTypes, argumentsForConstructor));
        }
        ...
        /// <param name="extraTypes"></param>
        /// <returns></returns>
        public static T GenerateDynamicMultiMock<T>(params Type[] extraTypes)
            where T : class
        {
            if (extraTypes == null)
                extraTypes = new Type[0];

            return CreateMockInReplay<T>(r => r.DynamicMultiMock<T>(extraTypes));
        }
        ...
        /// <param name="argumentsForConstructor"></param>
        /// <returns></returns>
        public static T GenerateDynamicMock<T>(params object[] argumentsForConstructor)
            where T : class
        {
            return CreateMockInReplay<T>(r => r.DynamicMultiMock<T>(new Type[0], argumentsForConstructor));
        }
        ...
        /// <param name="argumentsForConstructor"></param>
        /// <returns></returns>
        public static T GenerateDynamicMultiMock<T>(Type[] extraTypes, params object[] argumentsForConstructor)
            where T : class
        {
            return CreateMockInReplay<T>(r => r.DynamicMultiMock<T>(extraTypes, argumentsForConstructor));
        }
